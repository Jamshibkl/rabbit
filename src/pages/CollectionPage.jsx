  ...
  return (
    <div className="flex flex-col lg:flex-row relative">
      ...
      <div
        ...
        } fixed inset-y-0 left-0 w-64 bg-white overflow-y-auto transition-transform duration-300 z-50 lg:static lg:translate-x-0`}
      >
        <FilterSidebar />
      </div>

      {/* Product List (just for testing output) */}
